...
from .const import DOMAIN, CONF_INSTANCE_NAME, CONF_EARLIEST_START, DEFAULT_EARLIEST_START
...
async def async_setup_entry(
    ...
    async_add_entities([BrunnenEarliestStartTime(coordinator, entry)])
...
class BrunnenEarliestStartTime(CoordinatorEntity[BrunnenBewasserungCoordinator], TimeEntity):
